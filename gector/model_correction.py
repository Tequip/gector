            ...
            try:
                try:
                    ...
                    if 'append' in edit[1].lower():
                        ...
                        if 'TRANSFORM_CASE_CAPITAL' in edit[1]:
                            change_word = edit[2].capitalize()
                        elif 'TRANSFORM_CASE_LOWER' in edit[1]:
                            change_word = base_word.lower()
                        elif 'vbd' in edit[1].split('_')[-1].lower():
                        ...
                        elif 'agreement' in edit[1].lower() :
