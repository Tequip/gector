        ...
        for edit in edits:
            ...
            try:
                ...
                if 'append' in edit[1].lower():
                    if edit[0][2] in [',', '.']:
                        text['words'].insert(edit[0][0], {'text': edit[0][2], 'transform_into': '', 'mistake': '',
                                                          'appended': False, 'append_index': None})
                    else:
                        text['words'][edit[0][0] - 1]['transform_into'] = '__append'
                        text['words'][edit[0][0] - 1]['append_index'] = edit[0][0]
                        text['words'].insert(edit[0][0],
                                             {'text': edit[0][2], 'transform_into': '', 'mistake': '', 'appended': True,
                                              'append_index': None})
                ...
                print('EXCEPTION ON', edit, 'CONTEXT ', text['words'][edit[0][0]]['text'],
